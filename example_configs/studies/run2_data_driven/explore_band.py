...
def explore_band():
    ...
    plotmaker = collinearw.PlotMaker(config, "unfold_band")

    filter = "*reco_ABCD*rA*"
    process_sets = config.list_processes()#["unfold_realthang_fake-MU", "unfold_realthang_fake-EL"]
    print(process_sets)
