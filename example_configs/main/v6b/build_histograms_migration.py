...
def booking_control_regions(setting, filter_region_hist_types):
    common_cuts = "isReco && lep1Pt>30.0 && TMath::Abs(lep1Eta)<2.4 && trigMatch_singleLepTrig && jet1Pt>400.0 && jet1Pt <= 500.0"
...
def main():
    ...
    mc16a_setting = run_HistMaker.prepare_systematic(
        ...
        output="syst_config_per_process_migration",
        # executor=client,
