...

{
  ...
  "set_systematics" : {
    #"wjets_2211" : trigweight_EL_list + trigWeight_MU_list + leptonWeight_EL_List + leptonWeight_MU_List + jvtWeight_List + MUON_List + EG_List + MET_SoftTrk_List + JET_JER_List + JET_NP_List + bTagWeight_List + add_process_prefix("wjets_2211", ["MUR_MUF_Scale", "NNPDF30nnlo_hessian"]),
    #"zjets_2211" : trigweight_EL_list + trigWeight_MU_list + leptonWeight_EL_List + leptonWeight_MU_List + jvtWeight_List + MUON_List + EG_List + MET_SoftTrk_List + JET_JER_List + JET_NP_List + bTagWeight_List + add_process_prefix("zjets_2211", ["MUR_MUF_Scale", "NNPDF30nnlo_hessian"]),
    #"diboson" : trigweight_EL_list + trigWeight_MU_list + leptonWeight_EL_List + leptonWeight_MU_List + jvtWeight_List + MUON_List + EG_List + MET_SoftTrk_List + JET_JER_List + JET_NP_List + bTagWeight_List + add_process_prefix("diboson", ["Flat10Percent"]), # MUR_MUF has problem in mc16d diboson JET_NP_List + bTagWeight_List +  "MUR_MUF_Scale", "NNPDF30_PDF"
    "ttbar" : trigweight_EL_list + trigWeight_MU_list + leptonWeight_EL_List + leptonWeight_MU_List + jvtWeight_List + MUON_List + EG_List + MET_SoftTrk_List + JET_JER_List + JET_NP_List + bTagWeight_List + ["ttbar_matrix_element", "ttbar_parton_shower"] + add_process_prefix("ttbar", ["ren_fac_scale","ISR_scale","FSR_scale","NNPDF30_PDF"]),
    #"singletop" : trigweight_EL_list + trigWeight_MU_list + leptonWeight_EL_List + leptonWeight_MU_List + jvtWeight_List + MUON_List + EG_List + MET_SoftTrk_List + JET_JER_List + JET_NP_List + bTagWeight_List + add_process_prefix("singletop", ["ren_fac_scale"]),
  }
}
