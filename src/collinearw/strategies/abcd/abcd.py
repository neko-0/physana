...
def reserve_abcd_regions(
    ...
    Args:
        ...
        config (collinearw.configMgr.ConfigMgr) : configMgr object.
...
def add_region(config, name, selection, tag_list, tag_name=None, **kwargs):
    """
    wrapper of collinearw.configMgr.ConigMgr.add_region.
...
def event_level_fakes(
    ...
    *,
    ...
    Args:
        config : str or collinearw.configMgr.ConfigMgr:
            ConfigMgr object or the file name to the ConfigMgr object.

        tf_config : collinearw.configMgr.ConfigMgr:
