...
from . import jitfunc
from .histo_base import HistogramBase
from .histo_base import _hadd
from .histo_base import _hsub
from .histo_base import _hdiv
from .histo_base import _hmul
...
class Histogram(HistogramBase):
    ...
    def update_systematic_band(self, band: SystematicsBand):
