...
from ...core import HistogramAlgorithm, SystematicBase, Histogram, temporary_cache
import numpy as np
import logging
...
def stdev(process_set, sys_name):
    ...
    std_up.systematic = SystematicBase(
        sys_name, (sys_name, "stdev", "std_up"), "dummy", plist[0].systematic.sys_type
    )
    std_down.systematic = SystematicBase(
...
def hessian(process_set, sys_name):
    ...
    up.systematic = SystematicBase(
        sys_name, (sys_name, "hessian", "up"), "dummy", sys_type
    )
    down.systematic = SystematicBase(
...
def symmetrize_up_down(process_set, sys_name):
    ...
    sym_up.systematic = SystematicBase(
        sys_name,
    ...
    sym_dn.systematic = SystematicBase(
        sys_name,
