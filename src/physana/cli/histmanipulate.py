...
histManipulate = lazy("physana.histManipulate")
...
def abcd_fake(config, const_tf, oname, v):
    ...
    """
    logging.getLogger("physana.histManipulate").setLevel(getattr(logging, v.upper()))
    logging.getLogger("physana.core").setLevel(getattr(logging, v.upper()))
    logging.getLogger("physana.configMgr").setLevel(getattr(logging, v.upper()))
