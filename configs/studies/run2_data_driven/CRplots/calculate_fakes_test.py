...
tf_params = {
    ...
    "*muon*backtoback_*": (("abs(lep1Eta)", "lep1Pt"), "tf_eta_vs_lepPt_mu"),
...
def main(signal="wjets_2211", skip=["wjets", "zjets"]):
    ...
    fake_config.save('fakes_2211_nominal.pkl')
    ...
    run_PlotMaker.run_stack(
        ...
        "fakes_2211",
        data="data",
        mcs=["wjets_2211", "zjets_2211", "ttbar", "singletop", "diboson_powheg", "wjets_2211_tau", "dijets", "fakes"],
        low_yrange=(0.5, 1.7),
        logy=True,
        workers=None,
        rname_filter=["*rA*"],
